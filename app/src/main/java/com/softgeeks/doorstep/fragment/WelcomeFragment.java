...
//This is most first fragment it contains welcome screen which give a brief intro of your app by sliding different screen .In these screens you can
//see complete walk though or skip and use app as visitor or may move towards login screen
public class WelcomeFragment extends Fragment {
    ...
    //all controls are initialized in this method
    ...
    // in this method all active and in active dots in welcome screen there color and text are implemented in this method
